...
# STOPPED HERE. Created a full merge. Need to see if more cleaning is needed. If not, then I can start running analyses.
temp <- full_join(s1t1t2,s2t1t2)


# Haven't reviewed the code below.
